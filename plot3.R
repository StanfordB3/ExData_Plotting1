...
hPower <- read.table(currentFile, header=TRUE, sep=";", stringsAsFactors=FALSE, dec=".")
...
# hPwr2 <- hPwr[hPwr$Date %in% c("1/2/2007","2/2/2007") ,]
...
lines(hPwr2$Date_Time, subMetering1, col = "black")
# The data for Sub_metering_2 is different than the Dr. Peng's example
lines(hPwr2$Date_Time, subMetering2, col = "red") 
lines(hPwr2$Date_Time, subMetering3, col="blue")
