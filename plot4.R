...
plot(hPwr2$Date_Time, hPwr2$Global_active_power, type = "n", xlab = "", ylab = "Global Active Power")
lines(hPwr2$Date_Time, hPwr2$Global_active_power)
##
plot(hPwr2$Date_Time, hPwr2$Sub_metering_1, type = "n", xlab = "", ylab = "Energy sub metering")
